...
<ul>
    ...
    <li>Spring 2018 out-of-town co-ops and study abroad students are not eligible to apply this RECKruitment season. Fall 2019 out-of-town co-ops will be dealt with on a case by case basis. Email <a href="mailto:membershipchair@reckclub.org">Halle Bryan</a> if you have questions or concerns.</li>
</ul>

<h4 class="mb-3">Written Application</h4>

<p>The 2019 Ramblin’ Reck Club application is now closed. Check back next December for 2020's application!</p>

<h4 class="mb-3">Information Sessions (Non-Mandatory)</h4>
...
<ul>
    <li><strong>Tuesday, January 15</strong>: DM Smith 304 from 6:00pm-7:00pm</li>
...
<h4 class="mb-3">RRC/Athletics Bonding (Mandatory)</h4>
...
<ul>
    <li><strong>Sunday, January 20th</strong>: Women’s Basketball game vs. Syracuse at 2pm in McCamish Pavilion</li>
...
<p>After all interviews have been conducted, the Recruitment Chair will notify each applicant whether they will advance to the second round of RECKruitment. During this second round, applicants will attend a mandatory second social (invitation only) held on the evening of Monday, February 4th. Further details for this event will be published to applicants personally.</p>
    ...
    <p>Any time conflicts with these events should be brought to the attention of <a href="mailto:membershipchair@reckclub.org">Halle Bryan</a>, Ramblin’ Reck Club Recruitment Chair, no later than <strong>Saturday, January 26th</strong>.</p>
    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" src="/img/promo/2017-probates-football.jpg" alt="RRC's 2017 probate class posing in front of the Reck at a football game during the 2017 football season." style="width: 200px; height: 250px;">
            </div>
        </div>
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" src="/img/promo/2018-probates.jpg" alt="RRC's 2018 probate class at our annual spring alumni baseball tailgate." style="width: 200px; height: 250px;">
            </div>
        </div>
    </div>
</div>
