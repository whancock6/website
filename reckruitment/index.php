...
<!--    <p class="mt-0 text-muted"><i>Note: submission deadline and all event dates TBD for 2020</i></p>-->
    <ul>
        <li>A <a href="#written-application">written application</a> submitted by <strong>January 29</strong></li>
        <li>Attendance at one of the three selected <a href="#gtky-events">“Get to Know You” (GTKY)</a> Events</li>
        <li>Attendance at the <a href="#first-social">first social</a> on <strong>Monday, February 1st</strong></li>
        <li><a href="#interviews">Interviews</a> (individual and group), <strong>February 2nd - February 4th</strong></li>
        <li>Attendance at the <a href="#second-social">second social</a> on <strong>February 6th</strong> (by invitation only)</li>
        <li>Attendance at the all-club Spring Retreat (if selected to be a 2021 probate)</li>
    </ul>
    ...
    <p>To learn more about virtual events, please reach out for more information! Any absences or potential conflicts with the required events should be brought to the attention of <a href="mailto:membershipchair@reckclub.org">Whitney Miller</a>, Ramblin’ Reck Club Recruitment Chair, no later than Friday, January 29th.</p>
...
<ul>
    ...
    <li>Applicants may <strong>not</strong> graduate prior to December 2021.</li>
    ...
    <li>Spring 2021 out-of-town co-ops and study abroad students are not eligible to apply this RECKruitment season. Fall 2021 out-of-town co-ops will be dealt with on a case by case basis. Email <a href="mailto:membershipchair@reckclub.org">Whitney Miller</a>, Ramblin’ Reck Club Recruitment Chair, if you have questions or concerns.</li>
</ul>
...
<ul>
    <li><strong>Tuesday, January 19th at 7:00pm-8:00pm</strong> on <a href="https://bluejeans.com/603892164" target="blank">BlueJeans.</a> </li>
