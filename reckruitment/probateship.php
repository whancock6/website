...
<div class="container">
    ...
    <picture>
        <source class="img-responsive mb-2" srcset="/img/promo/PC20Pic_Fit.png" media="(min-width: 900px)" alt="Picture of members of Probate Class 20">
        <img class="img-responsive mb-2" src="/img/promo/PC20Pic.jpg" width="100%" alt="Picture of members of Probate Class 20">
    </picture>
