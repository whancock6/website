...
<div class="container">
    ...
    $info1 = array(
        ...
        [
            "image" => '/img/pennies/p-004-small.jpg',
...
<div class="container">
    ...
    <div class="row">
        <?php
        $donors = ['Akshay Easwaran','Ana Jafarinia','Annie Robinson','Arushi Gupta','Carter Kubes','Chelsea Yangnouvong','CJ Young','Daley Cass','Derek Prusener','Elizabeth Cowan','Emmett Halloran','Gigi P','Isabelle Liffiton','Jasper and Florence Jackson','Jen O\'Brien','Jill Riley','Marissa Klee','Matt O\'Brien','Matthew Askari','McKade Stewart','Megha Desai','Rachel Hurst','Robert Cottingham','Shivanee Persaud','Caroline Means','Emma Siegfried','Adam Lederer','Andy Begazo','Sean Walsh','Jo\'De Cummings','Hannah Schafer','J M Stewart','Maite Marin-Mera','Alec Liberman','Katie Earles','Caleb Torres','Grace Mallon','Sofia Eidizadeh','Nicholas Revelos','Taylor Gray','Jim Elliot','Samuel Stewart','Anonymous (in honor of Spring 2020 Graduates)', 'George P. Burdell', 'Keshav Ramanathan','Neha Embar','Allen Brower','Brittany Powell','Richard Chahine','Brendon Thaler','Savanna Panackal','Arianna Mastali','Sara Farnoli','Alicia Suarez','Beth Stayduhar','Angela Wharton','Jamie Bui','Marie Thompson','Mikayla Morgenroth','James Root','Petra and Rolf Schmitz','Tom Marchese','Nathan Peck','Lejla Dulic','Matt O\'Brien','Angelica Grace Nguyen','Ethan Rosman','Brianna Prindle','Ethan Kreager','Ross Kreager','Megan Kaiser','Helen Merkle','Michael Rosman', 'Ivey Brent', 'Amanda Healy', 'Trinity Wright', 'Karn Watcharasupat', 'Ani Benge', 'Bob Wang', 'Emily Farmer', 'Henna Mian', 'Jack Crawford', 'Shelby Conway', 'Matt DeJonge', 'Jordyn Seybolt', 'Allison White', 'Tanner Lee', 'Jefferson Martin', 'Cade Lawson', 'Rachel Mittal', 'Evan Strat', 'Dean Athanassiades', 'Landon Ballard', 'Chase Hughes', 'Marlene Garcia', 'Diana Michael', 'Abi Ivemeyer', 'Elvin Chirackal', 'Charles Hanzel III', 'Lily Arnold', 'Jenna Cliatt', 'Sydney Weisenburger', 'Towers 2 Residents','Narayan Shirolkar', 'Ivey Brent and Marla Laminack', 'Sunny Thomson', 'Alexandra Rachman', 'Ben Damus', 'Jake Grant', 'Brandon Dobson', 'Kassie Lee', 'Maxin Geller', 'Katie Coveny', 'Christopher Languell','Alise Yakovenko', 'Ally Rosenthal', 'Samuel Walters', 'Rob Gies', 'Ben Rochford', 'Jackson Larisch', 'Katie Thrift', 'Allison Riley', 'The Ivemeyer Family', 'Erika Lupuloff', 'Margaret Dickey', 'Kaushi Chandraratna', 'Cole Lewis', 'Annabelle Thomas', 'Clara McKay', 'Mari Nielsen', 'Hill Belfi', 'Varsha Padmanabhan', 'Madison Smith', 'Rose McKenna', 'Emily Hale', 'Zoe Sieling', 'Nick Isaf', 'Grace Truax', 'Ariane Richard', 'James Splitter', 'Lauren Lee', 'Julianne Schneider', 'Juliet Orth', 'Janie Johnson', 'Kirby Criswell', 'Brendan Mindiak','Cassie McIltrot','Joyrce K-S', 'Nicholas Jozwiak', 'Hedy Rosman'];
        sort($donors);
