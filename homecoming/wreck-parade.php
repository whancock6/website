...
<div class="container">
    ...
    $info1 = array(
        ...
        [
            ...
            "title" => 'COVID Update',
            "main" => '<p> In light of the COVID-19 situation, this year\'s Wreck Parade has undergone some new changes to keep participants and spectators safe and healthy. However, the spirit and fun of one of Georgia Tech’s most beloved traditions will be upheld. To keep the Ramblin\' Wreck Parade as safe as possible, this year the parade will be a car parade, consisting of classic cars and decorated vehicles (fixed bodies) that will travel a route around the entire campus.</p><p>This year we are encouraging spectators to watch from dorms/lawns along the new route. For those who are not physically on campus, the parade will be showcased the morning of Homecoming through a video produced at a later date.</p><p>We are excited to be able to adapt Wreck Parade to keep everyone involved safe. For more information on Wreck Parade changes please refer to the <a href="https://documentcloud.adobe.com/link/review?uri=urn:aaid:scds:US:8c71ab84-08c2-4c45-98f0-8325bb96c388">Wreck Parade 2020 Homecoming Rulebook.</a></p>'
        ],
        [
            "image" => '/homecoming/images/wp-002.jpg',
            "title" => 'Sign Ups',
            "main" => '<p>Sign ups are now in early September. If you are interested in participating in Wreck Parade this year please fill out this form:  <a href="https://forms.gle/7ZvBrVHfk6NFBn6P6">Wreck Parade Form</a> </p>'
